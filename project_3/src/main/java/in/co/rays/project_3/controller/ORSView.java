...
public interface ORSView {
	...
	public String APIKEY_CTL = APP_CONTEXT + "/ctl/APIKeyCtl";
    public String APIKEY_LIST_CTL = APP_CONTEXT + "/ctl/APIKeyListCtl";
	...
	public String LIMIT_CTL = APP_CONTEXT + "/ctl/LimitCtl";
    public String LIMIT_LIST_CTL = APP_CONTEXT + "/ctl/LimitListCtl";
	...
	public String LIMIT_LIST_VIEW = PAGE_FOLDER + "/LimitListView.jsp";
	public String LIMIT_VIEW = PAGE_FOLDER + "/LimitView.jsp";

	public String USAGE_LIST_VIEW = PAGE_FOLDER + "/UsageListView.jsp";
	public String USAGE_VIEW = PAGE_FOLDER + "/UsageView.jsp";

	public String APIKEY_LIST_VIEW = PAGE_FOLDER + "/APIKeyListView.jsp";
	public String APIKEY_VIEW = PAGE_FOLDER + "/APIKeyView.jsp";
